...
Now let's create a file, name it "index" and give it ".html" filename extension.
...
- the command `touch index.html` _create a file_ that name "index" with extension ".html"
...
as you can see I added a little smiley face to my code :) hardcore hacker lol!
